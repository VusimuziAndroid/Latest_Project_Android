...
public class FriendshipRequests extends AppCompatActivity {
    ...
    public void getInvitationsList(){
      ...
      //  Bitmap bm = BitmapFactory.decodeResource(getResources(),R.drawable.ic_linkedin_pro_pic1);
        ...
        invitationsList.add(new TimeLineInvitations(R.drawable.ic_linkedin_pro_pic2,"Patric Farewell","Communications Professionals",R.drawable.navigation_cancel,R.drawable.ic_person_add_black_48dp));
        ...
        invitationsList.add(new TimeLineInvitations(R.drawable.ic_linkedin_pro_pic4,"Wiston","Global Business director",R.drawable.navigation_cancel,R.drawable.ic_person_add_black_48dp));
        invitationsList.add(new TimeLineInvitations(R.drawable.ic_linkedin_pro_pic5,"Paolo","Marketing Manager - I07 Wearable Professional",R.drawable.navigation_cancel,R.drawable.ic_person_add_black_48dp));
        invitationsList.add(new TimeLineInvitations(R.drawable.ic_linkedin_pro_pic6,"H. Jay","Principal Communications Group",R.drawable.navigation_cancel,R.drawable.ic_person_add_black_48dp));
    }
