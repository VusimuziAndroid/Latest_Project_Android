...
public class Items {
    ...
    String fullName;
    String allComments;
    public Items(int proPicture,String name,String role,String time,String story,int timelinePic,String storyLine,String site,String likes,String likes2,String comments,int imgLikes,int imgComments,int imgShare){
